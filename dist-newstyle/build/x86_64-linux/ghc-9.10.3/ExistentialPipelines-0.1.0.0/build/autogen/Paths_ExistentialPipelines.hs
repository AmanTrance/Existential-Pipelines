...
{-|
Module      : Paths_ExistentialPipelines
...
-- at runtime using the environment variable ExistentialPipelines_bindir.
...
-- environment variable ExistentialPipelines_libdir.
...
-- using the environment variable ExistentialPipelines_dynlibdir.
...
-- runtime using the environment variable ExistentialPipelines_datadir.
...
-- variable ExistentialPipelines_libexedir.
...
-- using the environment variable ExistentialPipelines_sysconfdir.
...
bindir     = "/home/amanfreecs/.cabal/bin"
libdir     = "/home/amanfreecs/.cabal/lib/x86_64-linux-ghc-9.10.3-2929/ExistentialPipelines-0.1.0.0-inplace"
dynlibdir  = "/home/amanfreecs/.cabal/lib/x86_64-linux-ghc-9.10.3-2929"
datadir    = "/home/amanfreecs/.cabal/share/x86_64-linux-ghc-9.10.3-2929/ExistentialPipelines-0.1.0.0"
libexecdir = "/home/amanfreecs/.cabal/libexec/x86_64-linux-ghc-9.10.3-2929/ExistentialPipelines-0.1.0.0"
sysconfdir = "/home/amanfreecs/.cabal/etc"

getBinDir     = catchIO (getEnv "ExistentialPipelines_bindir")     (\_ -> return bindir)
getLibDir     = catchIO (getEnv "ExistentialPipelines_libdir")     (\_ -> return libdir)
getDynLibDir  = catchIO (getEnv "ExistentialPipelines_dynlibdir")  (\_ -> return dynlibdir)
getDataDir    = catchIO (getEnv "ExistentialPipelines_datadir")    (\_ -> return datadir)
getLibexecDir = catchIO (getEnv "ExistentialPipelines_libexecdir") (\_ -> return libexecdir)
getSysconfDir = catchIO (getEnv "ExistentialPipelines_sysconfdir") (\_ -> return sysconfdir)
