...
/* package ExistentialPipelines-0.1.0.0 */
#ifndef VERSION_ExistentialPipelines
#define VERSION_ExistentialPipelines "0.1.0.0"
#endif /* VERSION_ExistentialPipelines */
#ifndef MIN_VERSION_ExistentialPipelines
#define MIN_VERSION_ExistentialPipelines(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_ExistentialPipelines */
...
#define CURRENT_PACKAGE_KEY "ExistentialPipelines-0.1.0.0-inplace"
#endif /* CURRENT_packageKey */
#ifndef CURRENT_COMPONENT_ID
#define CURRENT_COMPONENT_ID "ExistentialPipelines-0.1.0.0-inplace"
